...
pub const LOCKFILE_HEADER_COMMENT: &str = "# Automatically generated by Wisteria, do not edit.\n";
...
pub fn lockfile_artifacts_to_toml(
    ...
    let mut toml = toml::to_string_pretty(&lockfile)
        .map_err(|e| format!("Failed to serialize lockfile TOML: {e}"))?;

    toml.insert_str(0, LOCKFILE_HEADER_COMMENT);
