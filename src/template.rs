...
use crate::{
    ...
    eclipse::eq_sep_config::EclipseConfiguration,
    maven::{repository, repository::ArtifactVersion},
    nature::Nature,
    project::Project,
    util::files,
    Metadata,
...
pub fn generate_pom(project: &Project, configuration: &Configuration) -> Result<String, String> {
    ...
    writer
        ...
        .map_err(|e| e.to_string())?;
    writer
        .write(XmlEvent::characters("com.example"))
        .map_err(|e| e.to_string())?;
    writer
        .write(XmlEvent::end_element())
        .map_err(|e| e.to_string())?;
    ...
    writer
        ...
        .map_err(|e| e.to_string())?;
    writer
        .write(XmlEvent::characters(project.info().version()))
        .map_err(|e| e.to_string())?;
    writer
        .write(XmlEvent::end_element())
        .map_err(|e| e.to_string())?;
    ...
    writer
        ...
        .map_err(|e| e.to_string())?;
    writer
        .write(XmlEvent::start_element("maven.compiler.release"))
        .map_err(|e| e.to_string())?;
    writer
        .write(XmlEvent::characters(
            configuration.java_version().to_string().as_str(),
        ))
        .map_err(|e| e.to_string())?;
    writer
        .write(XmlEvent::end_element())
        ...
        match dependency {
            Dependency::FetchFromMaven {
                ...
                writer
                    ...
                    .map_err(|e| e.to_string())?;
                writer
                    .write(XmlEvent::characters("{group_id}"))
                    .map_err(|e| e.to_string())?;
                writer
                    .write(XmlEvent::end_element())
                    .map_err(|e| e.to_string())?;
                ...
                writer
                    ...
                    .map_err(|e| e.to_string())?;
                writer
                    .write(XmlEvent::characters("{artifact_id}"))
                    .map_err(|e| e.to_string())?;
                writer
                    .write(XmlEvent::end_element())
                    .map_err(|e| e.to_string())?;
                ...
                match version {
                    Some(v) => {
                        ...
                        let maven_version = repository::get_version(
                            ...
                            artifact_id,
                            classifier.as_ref(),
                            &ArtifactVersion::Version { version: v.clone() },
                        )
                        .map_err(|e| e.to_string())?;
                        writer
                            .write(XmlEvent::characters("{artifact_id}-{maven_version}"))
                            .map_err(|e| e.to_string())?;
                    }
                    None => {
                        // TODO Fix this
